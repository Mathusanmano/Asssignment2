	...
	public static void main(String[] args) {
	    ...
	    //Access & Login the letcodein page
		  WebDriverManager.chromedriver().setup();
	        ...
	        WebElement input = driver.findElement(By.xpath("/html/body/app-root/app-test-site/section[2]/div/div/div/div[3]/app-menu/div/footer/a"));
	        input.click();
	        test1.pass("click select button");
